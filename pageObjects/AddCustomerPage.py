...
class AddCustomer:
    ...
    lstnewsletter_xpath = "//li[contains(text(), 'Your store name')]"
    ...
    def newsletter(self):
        ...
        time.sleep(3)
        #WebDriverWait(self.driver, 10).until(expected_conditions.presence_of_element_located(self.lstnewsletter_xpath))
